...
function startingPrompt() {
    inquirer.prompt([
        {
            message: "/////////Welcome to your personal Team Generator Please Enter your team name://///////",
            name: "teamname"
        }
    ])
        .then(function(data){
...
function addTeamMembers() {
    inquirer.prompt([
        {
            type: "list",
            message: "Please select from the options below to add more team members?",
...
function addEngineer() {
    inquirer.prompt([
        ...
        {
            message: "What is you're engineer's email address?",
            name: "email"
        },
        {
            message: "What is you're engineer's Github profile?",
            name: "github"
        }
    ])
...
function addIntern() {
    inquirer.prompt([
        ...
        {
            message: "What school is your intern currently attending or graduated from?",
            name: "school"
        }
    ])
...
<body>
    ...
    fs.writeFile(`./rendered-html/${finalTeamArray[0]}.html`, htmlArray.join(""), function (err) {
